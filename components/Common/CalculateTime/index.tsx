...
const checkDay = (postDate:dayjs.Dayjs, thisYear:dayjs.Dayjs, beforeYesterday:dayjs.Dayjs, yesterday:dayjs.Dayjs, today:dayjs.Dayjs):string => {
...
export const CalculateTime:React.FC<Props> = ({ date, type, postId, msg }) => {
