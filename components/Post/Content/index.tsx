...
interface Props {
  ...
  setShowPostModal?:Dispatch<SetStateAction<boolean>> // undefined pass by post-modal
  currentPage?:number // undefined pass by post-modal
  propClass?:"comment-modal"|"post-modal"
}
const Content:React.FC<Props> = ({
  ...
  const [toggleLikeLoading, setToggleLikeLoading] = useState<boolean>(false);
  const likeListRef = useRef<HTMLUListElement>(null);
  ...
  const handleToggleLike = async (e:React.MouseEvent<SVGElement>, mode:"unlike"|"like") => {
