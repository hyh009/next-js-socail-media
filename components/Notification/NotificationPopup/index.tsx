...
import {NewNotificationState} from "../../../utils/types"
...
interface Props {
  ...
  closeNotificationPopup:React.MouseEventHandler<SVGElement> // click to close
}
const NotificationPopup:React.FC<Props> = ({ newNotification, closeNotificationPopup }) => {
